...
@section('konten')
    <div class="section">
        <div class="card">
            <div class="card-body">
                <form action="{{ route('data.agenda.store') }}" method="post" class="form">
                    @csrf
                    <div class="row">
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                                <label for="nama">Nama Rapat</label>
                                <input type="text" name="nama" id="nama" class="form-control" placeholder="Masukkan Nama Rapat" value="{{ old('nama') }}" required autofocus>
                            </div>
                        </div>
                        <div class="col-md-6 col-12">
                            <div class="form-group">
                            ...
                            <div class="form-group">
                                ...
                                <select name="ruangan" id="ruangan" class="form-select" required>
                                    ...
                                    @foreach ($ruangan as $r)
                                        <option value="{{ $r->id }}" {{ old('ruangan') == $r->id ? 'selected' : '' }}>{{ $r->nama }} - {{ $r->lokasi }}</option>
                                    @endforeach
                                </select>
                            </div>
                        </div>
                        <div class="col-12 mt-2">
                            ...
                            <div class="row" id="daftarPeserta" style="max-height: 400px; overflow-y: auto; padding: 5px;">
                                @foreach($peserta as $p)
                                    <div class="col-12 col-md-4 col-lg-3 mb-2 item-peserta"> <!-- Menggunakan col-md-4 atau col-lg-3 agar lebih banyak card menyamping -->
                                        <div class="card h-100 border shadow-sm" style="border-radius: 8px;">
                                            <div class="card-body p-2 d-flex align-items-center">
                                                ...
                                                <div style="line-height: 1.2;">
                                                    <strong class="nama-peserta d-block text-truncate" style="font-size: 0.9rem; max-width: 150px;" title="{{ $p->nama }}">
                                                        {{ $p->nama }}
                                                    </strong>
                                                    <small class="jabatan-peserta text-muted d-block" style="font-size: 0.75rem;">
                                                        {{ $p->jxi->nama_jabatan }}
                                                    </small>
