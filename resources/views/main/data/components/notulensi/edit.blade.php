        ...
        <div class="card">
            <div class="card-body">
                <form action="{{ route('data.notulensi.update', $data->id) }}" method="post" class="form"
                    ...
                    <div class="row">
                        <div class="col-12">
                            <label for="rapat">Nama Agenda Rapat</label>
                        ...
                        <div class="col-12 mt-2">
                            <label for="isi">Isi Notulensi</label>
                        ...
                        <div class="col-md-6 col-12 mt-2">
                            <label for="publish">Tampilkan Publik</label>
                            <select name="publish" id="publish" class="form-select" required>
                                <option value="">-- Pilih Tampilkan Publik --</option>
                                <option value="1" {{ old('publish', $data->publish) == '1' ? 'selected' : '' }}>
                                    Ya
                                </option>
                                <option value="0" {{ old('publish', $data->publish) == '0' ? 'selected' : '' }}>
                                    Tidak
                                </option>
                            </select>
                        </div>
                        ...
                        <div class="col-md-6 col-12 mt-2" id="aktif-sampai-wrapper" style="display: none;">
                            <label for="aktif_sampai">Aktif Sampai</label>
                            <input type="date" name="aktif_sampai" id="aktif_sampai" class="form-control"
                                value="{{ old('aktif_sampai', $data->sampai) }}">
                        </div>
